...
ETHOS.jl follows the language policy established by the project specification:
...
Cross-corpus embedding comparisons must use an explicit alignment step. Any window-based change must include a regression test proving that document boundaries cannot be crossed.
