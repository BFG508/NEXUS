...
## 10. Bootstrap por bloques

El muestreo independiente de tokens rompería demasiado la estructura local del texto. El pipeline divide cada corpus en bloques contiguos de tamaño configurable y remuestrea bloques con reemplazo.
